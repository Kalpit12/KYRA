...
export const vehicleTypes: VehicleType[] = [
  ...
  },
  {
    ...
    name: "Mini SUV",
    modelName: "BMW X3",
    description: "BMW X3 — compact luxury SAV",
    features: ["Sport activity stance", "Premium cabin", "Urban agility"],
    modelPath: "/models/bmw_x3.glb",
  },
  {
    id: "pickup",
    name: "Pickup",
    modelName: "Ford Ranger",
    description: "Ford Ranger — double-cab pickup",
    features: ["Double cab", "Cargo bed", "Off-road stance"],
    modelPath: "/models/ford_ranger.glb",
  },
  {
    id: "coupe",
    name: "Coupe",
