...
import { prefetchSimulatorModel } from "@/lib/simulator/preload";
      ...
      <div className="mt-8 md:mt-10">
        ...
        {vehicles.map((vehicle, index) => (
          <motion.button
            ...
            onMouseEnter={() => prefetchSimulatorModel(vehicle.modelPath)}
            onFocus={() => prefetchSimulatorModel(vehicle.modelPath)}
            className={cn(
